...
/*******************************************************************************
  * File Name          : lab6.c
  * Description        : used to rotate the stepper motor by generating delays using interrupts
  * 
  * Author:            : Meet Patel
  * Date:              :  13-10-2021
  ******************************************************************************
...
{ 
fetch_uint32_arg(&timer);
fetch_int16_arg(&state);
intialize();
if (state < 0)
{
...
ADD_CMD("timer_and_state",Init,"<timer> <state>  Initialize timer")
